...
class ExamParallelQuestion extends StatefulWidget {
  const ExamParallelQuestion(
      {super.key, required this.id, required this.selectedParallel});
  final int id;
  final int selectedParallel;

  @override
  State<ExamParallelQuestion> createState() => _ExamParallelQuestionState();
}

class _ExamParallelQuestionState extends State<ExamParallelQuestion> {

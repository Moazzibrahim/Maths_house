...
class QuizScoreScreen extends StatelessWidget {
  const QuizScoreScreen({
    ...
    required this.missedQuestionsNumber,
  });

  final QuizzesModel quiz;
  final Set<QuestionsQuiz> correctAnswers;
  final Set<int> wrongAnswers;
  final int missedQuestionsNumber;

  @override
  Widget build(BuildContext context) {
    double scorePercentage = (correctAnswers.length / quiz.questionQuizList.length) * 100;
    String formattedScore = '${scorePercentage.toStringAsFixed(2)}%';
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            _buildInfoRow('Score:', formattedScore),
            ...
            _buildInfoRow('Wrong Answers:', (wrongAnswers.length + missedQuestionsNumber).toString()),
            _buildInfoRow('Missed Questions:', missedQuestionsNumber.toString()),
